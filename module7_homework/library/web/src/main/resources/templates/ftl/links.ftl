<div class="links">
    <fieldset>
        ...
        <ul>
            <li>
                <a href="/create-author">Create new author</a>
            </li>

            <li>
                <a href="/author">Search for author</a>
            </li>
    ...
    <fieldset>
        <legend>Borrow links:</legend>
        <ul>
            <li>
                <a href="/create-borrow">Create new borrow</a>
            </li>

            <li>
                <a href="/borrow">Search for borrow</a>
            </li>

            <li>
                <a href="/borrows">List all borrows</a>
            </li>
        </ul>
    </fieldset>

    <fieldset>
        <legend>Inventory links:</legend>
        <ul>
            <li>
